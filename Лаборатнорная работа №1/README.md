...
3. Если да, вывести 20, иначе- саму сумму s.
...
### Алгоритм решения
1. Использовать switch для проверки x: для каждого case перейти на соответствующий день недели
...
### Алгоритм решения
1. Инициализируем цикл for для строк: пройти от 0 до x-1
2. Внутренний цикл for для символов в строке: пройти от 0 до x-1, печатаем "*"
3. После каждого внутреннего цикла перейти на новую строку с помощью println().
...
### Алгоритм решения
1. Инициализируем цикл for для строк: пройти от 1 до x
...
2. Как только найдётся такой arr[i] равный x, сразу вернуть i как индекс
...
### Алгоритм решения
1. ИСоздать max равный первому элементу arr[0]
